...
function climateProject(locale: ExampleLocale): ProjectData {
  ...
  return {
    ...
    seasons: [
      {
        ...
        episodes: [
          ...
          {
            id: 'klima-ep-waerme',
            title: 'Waerme auf der Flucht',
            summary:
              'Temperaturkarten und Raumprotokolle zeigen, wo Fenster, Heizkoerper und Routinen zu viel Heizenergie verlieren.',
          ...
          },
          {
            ...
            summary:
              'Das Team untersucht Lebensmittelreste, Transportwege und regionale Alternativen fuer eine klimabewusstere Schulmensa.',
      ...
      },
      {
        ...
        title: 'Staffel 2: Massnahmen',
        episodes: [
          {
            id: 'klima-ep-daten',
            title: 'Der Datenbeweis',
            summary:
              'Diagramme, Kostenschaetzungen und Kurzinterviews machen aus Beobachtungen belastbare Argumente fuer die Schulleitung.',
          ...
          },
          {
            ...
            title: 'Der Klimarat',
            summary:
              'Gruppen diskutieren Komfort, Kosten, Fairness und Umsetzbarkeit, bevor sie ueber realistische Massnahmen abstimmen.',
            altText: 'Eine Klasse praesentiert Klimadaten in einer Schulbesprechung.',
          },
          {
            id: 'klima-ep-montag',
            title: 'Ein Plan fuer Montag',
            summary:
              'Das Finale buendelt drei Sofortmassnahmen, zwei mittelfristige Projekte und eine Frage fuer das naechste Unterrichtsvorhaben.',
    ...
    reflection:
      'Das Projekt macht sichtbar, dass Messen, Deuten und Kommunizieren zusammengehoeren. Die Lernenden trennen Beobachtungen, Vermutungen und Belege, bevor sie konkrete Veraenderungen fuer ihre Schule vorschlagen.',
    sources:
      'Messprotokoll der Klasse; Interview mit der Hausmeisterei; Unterrichtsmaterial des Umweltbundesamts zum Energiesparen; Notizen zur Mensa-Abfallmessung; Rueckmeldung der SV.',
    customConceptTitle: 'Bildprompts und Social-Media-Kit',
    customConceptText:
      'Social-Media-Text: Klasse 8b verwandelt Energiedaten in eine Streaming-Recherche. Das Projekt zeigt Messen, Diskutieren und konkrete Klimamassnahmen fuer die Schule in sechs Episoden.\n\nHashtags: #SeriesCreator #Schulprojekt #Klimabildung #Medienbildung\n\nCover-Prompt: Wide cinematic documentary still of a modern German school building at sunrise, students with clipboards and an energy meter in the courtyard, realistic, natural light, no text, 16:9.\n\nEpisoden-Prompts: 1. Students measuring classroom devices with a plug-in power meter, realistic documentary photo, no text, 16:9. 2. Thermal-camera-inspired view of classroom windows and radiators, students comparing notes, no text, 16:9. 3. School cafeteria with students weighing food waste and checking regional ingredients, no text, 16:9. 4. Students analyzing charts and spreadsheets on a classroom screen, no text, 16:9. 5. Student climate council presenting findings to teachers, constructive meeting atmosphere, no text, 16:9. 6. Students arranging action cards on a classroom board, practical planning mood, no text, 16:9.',
  };
}
...
function weimarProject(locale: ExampleLocale): ProjectData {
  ...
  return {
    ...
    description:
      'Ein Geschichtskurs inszeniert die Weimarer Republik als Recherche-Serie: demokratische Hoffnungen, Krisendruck, Medienkaempfe und Fragen nach Verantwortung.',
    previewBrand: 'HistoryLab',
        ...
        episodes: [
          {
            ...
            summary:
              'Die Auftaktfolge erklaert das Ende des Kaiserreichs, die neue Verfassung und die Versprechen der parlamentarischen Demokratie.',
            altText: 'Lernende untersuchen eine historische Zeitleiste zur Weimarer Republik.',
          },
          {
            id: 'weimar-ep-krise',
            title: 'Inflation auf der Strasse',
            summary:
              'Die Lernenden verbinden Hyperinflation, Alltagserfahrungen und politische Radikalisierung mit fiktiven Quellenakten.',
            altText: 'Schuelerinnen und Schueler vergleichen Quellenkarten zur Hyperinflation.',
          },
          {
            id: 'weimar-ep-kultur',
            title: 'Lichter der Moderne',
            summary:
              'Die Klasse untersucht Kultur, Rollenbilder, Kino und Stadtleben als Zeichen gesellschaftlicher Veraenderung.',
        ...
        episodes: [
          {
            ...
            summary:
              'Wahlplakate und Zeitungsausschnitte zeigen, wie politische Gruppen um Aufmerksamkeit, Angst und Loyalitaet kaempfen.',
          ...
          },
          {
            ...
            summary:
              'Die Folge verknuepft Wahlergebnisse, Strassengewalt, Praesidialkabinette und den schwindenden Raum fuer Kompromisse.',
            altText: 'Lernende diskutieren ein Diagramm mit Wahlergebnissen.',
          },
          {
            id: 'weimar-ep-frage',
            title: 'Haette es anders kommen koennen?',
            summary:
              'Das Finale macht aus der Recherche eine moderierte Klassendebatte ueber Ursachen, Verantwortung und demokratische Widerstandsfaehigkeit.',
            altText: 'Eine Klasse fuehrt eine moderierte Debatte im Geschichtsraum.',
          },
        ],
      },
    ],
    reflection:
      'Dieses Beispiel macht Chronologie, Quellenkritik, Perspektivuebernahme und historische Urteilsbildung sichtbar. Die Lernenden erzaehlen Ereignisse nicht nur nach, sondern formen aus Belegen eine strukturierte Argumentation.',
    sources:
      'Schulbuchkapitel zur Weimarer Republik; ausgewaehlte Verfassungsauszüge; Wahlergebnistabellen; historische Plakate; Zeitungsauszüge; Notizen aus der Klassendebatte.',
    customConceptTitle: 'Bildprompts und Social-Media-Kit',
    customConceptText:
    ...
    return [
      {
        ...
        featureHighlights: [
          ...
          'Ready for presentation, PDF, HTML, and project export',
        ],
        socialCopy:
      ...
      },
      {
        ...
        featureHighlights: [
          ...
          'Demonstrates exports with a humanities project',
        ],
        socialCopy:
  ...
  return [
    {
      ...
      featureHighlights: [
        ...
        'Nutzbar für Präsentation, PDF, HTML und Projektdatei',
      ],
      socialCopy:
        'Klasse 8b verwandelt Energiedaten in eine Streaming-Recherche mit konkreten Klimamassnahmen fuer die Schule.',
      hashtags: ['#SeriesCreator', '#Schulprojekt', '#Klimabildung', '#Medienbildung'],
      imagePrompts: [
    ...
    },
    {
      ...
      featureHighlights: [
        'Historische Chronologie ueber zwei Staffeln',
        'Quellenkritik und Debatte in Episoden sichtbar',
        'Konzept-Tab enthaelt wiederverwendbares Social-Media-Material',
        'Zeigt Exportpfade mit einem geisteswissenschaftlichen Projekt',
      ],
      socialCopy:
        'Ein Geschichtskurs verwandelt die Weimarer Republik in eine sechsteilige Quellenrecherche ueber Demokratie unter Druck.',
      hashtags: ['#SeriesCreator', '#Geschichtsunterricht', '#WeimarerRepublik', '#Demokratiebildung'],
      imagePrompts: [
        'Classroom archive table with Weimar-era documents, election posters, magnifying glass, realistic investigation mood, no text, 16:9.',
        'Moderated classroom debate with source cards on desks, serious but constructive mood, no text, 16:9.',
